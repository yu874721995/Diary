        ...
        parent.layer.prompt({
            ...
            parent.layer.open({
                ...
                , content: '<div class="layui-form" style="margin: 30px">' +
                    ...
                    '<div class="layui-form-item" id="name-mk" style="margin-top: 50px"><label class="layui-form-label">类型名称</label>' +
                    '<input id="mkName" type="text" name="mkName" required lay-verify="required" placeholder="请输入类型名称" autocomplete="off" class="layui-input layui-input-inline"></div>' +
                    '</form></div>'
...
function deleteimg(i,obj,index) {
    $("#bimg" +i).remove();
